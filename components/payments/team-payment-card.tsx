...
import type { TeamPaymentState } from "@/lib/payments/registration-plan";
...
export function TeamPaymentCard({
  ...
  /** The organizer's Stripe account can take money and captain-pays is allowed. */
        ...
        <CardContent className="space-y-4">
          ...
          {canPayOnline && canPay ? (
            ...
            <p className="text-muted-foreground text-sm">
              {canPayOnline
                ? "Only this team's members can pay online."
                : "Card payment isn't available for this event yet — arrange payment with the organizer."}
            </p>
          )}
        </CardContent>
      )}
